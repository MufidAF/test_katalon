...
WebUI.setText(findTestObject('Object Repository/Page_DEMOQA/input/input_UserName_userName'), 'userinvalid')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_DEMOQA/input/input_Password_password'), 'aVK4AJkKLR+Cz54MVrbLkQ==')
